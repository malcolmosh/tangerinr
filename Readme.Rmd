...
**ATTENTION : l'extension du fichier csv doit être en majuscules (".CSV")**
...
tan_agreg(importation, tout=FALSE,mois=04) #n'afficher que les dépenses d'avril
```
...
tan_graphique(tout=FALSE,annee=2020)
```
